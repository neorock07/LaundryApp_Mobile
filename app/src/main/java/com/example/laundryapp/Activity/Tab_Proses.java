...
public class Tab_Proses extends Fragment {

    private RecyclerView rc;
    private SwipeRefreshLayout swp;
    private ProgressBar bar;
    private Adapter_Proses adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = LayoutInflater.from(getContext()).inflate(R.layout.fragment_tab__proses, container, false);
        rc = v.findViewById(R.id.rc_proses);
        ...
        resp.enqueue(new Callback<Model_Response>() {
            ...
            public void onResponse(Call<Model_Response> call, Response<Model_Response> response) {
                ...
                if(response.body().getKode() == 0){
                    ...
                    adapter = new Adapter_Proses(getContext(), dataList);
